...
<div class="card md-2">
    <div class="card-head">
            <h4 class="card-header bg-secondary text-white text-center">Formulaire des ventes</h4>
        </div>
        <div class="card-body">
            <div class="row">
             ...
             <div class="">
                        ...
                        <select name="" id="" class="form-control">
                            ...
                            <option value="">Sous Offre</option>
                            <option value="">En attente de financement</option>
                            <option value="">Annulée </option>
                            <option value="">En attente de signature</option>
                            <option value="">En attente de clôture</option>
